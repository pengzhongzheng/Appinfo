...
<div class="row">
    <div class="col-md-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <form method="post" action="appInfo/list">
                                            ...
                                            <div class="btn-group">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    ...
                                                    <li><a  class="modifyAppInfo"
                                                            appinfoid="${appInfo.id }" status="${appInfo.status }" statusname="${appInfo.statusName }" data-toggle="tooltip" data-placement="top" title="" data-original-title="修改APP基础信息">修改</a></li>
